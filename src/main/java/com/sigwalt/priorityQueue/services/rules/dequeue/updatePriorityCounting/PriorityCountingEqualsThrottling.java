...
public class PriorityCountingEqualsThrottling extends UpdatePriorityCountingRules {


	public PriorityCountingEqualsThrottling(Map<Integer, Integer> priorityCounting,
